      ...
      const campaigns = await fetch(
        "https://nandqoilqwsepborxkrz.supabase.co/rest/v1/campaigns?select=name,ad_url",
        {
          headers: {
            ...
            Authorization: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5hbmRxb2lscXdzZXBib3J4a3J6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NTM1OTA4MCwiZXhwIjoyMDYwOTM1MDgwfQ.qpDZpRJq2Tk48QgUwY1RGQwf2f89Mo4UyEbgek-AyNk",
          },
        }
      ).then((r) => r.json());
